...
<body>
    ...
    <header>
        <div class="container">
            <h1><a href="dashboard.php">Galeri | Hbz</a></h1>
            <ul>
            ...
            <div class="box">
                ...
                if (isset($_POST['submit'])) {
                    ...
                    if (!in_array($type2, $tipe_diizinkan)) {
                        ...
                        echo '<script>alert("{ code: 403, pesan: Format extensi file tidak diizinkan! }")</script>';
                    } else {
    ...
    <footer>
        <div class="container">
            <small>Copyright &copy; 2024 - Galeri | Hbz.</small>
        </div>
    </footer>
    <!-- <script>
